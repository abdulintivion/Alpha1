<?php
define("TOKEN", "Google@101");                                       // The secret token to add as a GitHub or GitLab secret, or otherwise as https://www.example.com/?token=secret-token
define("REMOTE_REPOSITORY","git@github.com:Intivion/4-mkt.com-website.git"); // The SSH URL to your repository
define("DIR", "/var/www/4-mkt.com/");                          // The path to your repostiroy; this must begin with a forward slash (/)
define("BRANCH", "refs/heads/main");                               // The branch route
define("LOGFILE", "/var/www/applogs/4-mkt.com/deploy.log");                   // The name of the file you want to log to.
